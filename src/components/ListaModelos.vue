<template>
  <div class="container-fluid my-1 p-3 border rounded-3 shadow-sm bg-light">
    <!-- Título principal -->
    <h4
      class="text-center mx-2 my-1 bg-`primary-subtle py-1 bg-opacity-25 p-3 rounded"
      style="color: #7a0f16"
    >
...
const opcionesMarca = ["Citroën", "Nissan", "Seat", "Toyota", "Ford"];
